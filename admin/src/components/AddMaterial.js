...
function AddMaterial({index,handleDeleteMaterial,materialProducts,setMaterialProducts,material }) {
  ...
  return (
    <ul>
            ...
            <li>
                <InputSelectBox setParams={setType} options={material} />
            </li>
            <li>
                <InputDoubleBox  _width="100px"  setParams={setWeight} />
            </li>
            <li>
                {
                index >= 1 ? 
