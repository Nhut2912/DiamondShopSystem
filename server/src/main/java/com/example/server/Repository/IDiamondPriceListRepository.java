...
public interface IDiamondPriceListRepository extends CrudRepository<DiamondPriceList, Long> {
    ...
    @Query(value = "select * from diamond_price_list where clarity_id = :clarity_id and color_id = :color_id and cut_id = :cut_id and origin_id = :origin_id and :carat >= carat_from and :carat < carat_to", nativeQuery = true)
