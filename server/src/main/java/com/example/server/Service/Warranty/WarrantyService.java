...
public class WarrantyService implements IWarrantyService {
    ...
    public boolean updateWarranty(WarrantyDTO warrantyDTO) {
        ...
        try {
            ...
            Optional<Warranty> warranty = iWarrantyRepository.findById(warrantyDTO.getId());
            warranty.get().setDateStart(warrantyDTO.getDateStart());
            warranty.get().setDateEnd(warrantyDTO.getDateEnd());
            warranty.get().setStatus(warrantyDTO.isStatus());
            iWarrantyRepository.save(warranty.get());
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        return false;
    ...
    public List<WarrantyDTO> getWarranties() {
        ...
        for (Warranty warranty : iWarrantyRepository.findAll()) {
            ...
            warrantyDTO.setStatus(warranty.isStatus());
